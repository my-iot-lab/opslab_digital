...
public class JwtHandler : AppAuthorizeHandler
{
    ...
    private static async Task<bool> CheckAuthorzieAsync(DefaultHttpContext httpContext)
    {
        ...
        return permissionList.Exists(p => p.Equals(routeName, StringComparison.CurrentCultureIgnoreCase)) ||
            allPermissionList.TrueForAll(p => !p.Equals(routeName, StringComparison.CurrentCultureIgnoreCase));
    }
}
